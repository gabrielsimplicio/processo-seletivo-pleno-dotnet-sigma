...
CREATE TABLE meupatrimonio.MODELO(
	...
	CONSTRAINT FK_MODELO_MARCA_ID FOREIGN KEY (MARCAID) REFERENCES meupatrimonio.MARCA(ID)
) ON [PRIMARY]
GO
...
CREATE TABLE meupatrimonio.PATRIMONIO(
	...
	CONSTRAINT FK_PATRIMONIO_MARCA_ID FOREIGN KEY (MARCAID) REFERENCES meupatrimonio.MARCA(ID),
	CONSTRAINT FK_PATRIMONIO_MODELO_ID FOREIGN KEY (MODELOID) REFERENCES meupatrimonio.MODELO(ID)
) ON [PRIMARY]
GO
